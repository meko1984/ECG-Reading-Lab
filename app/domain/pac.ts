...
export const PAC_ORIGINS: PACOrigin[] = [
  {
    ...
    siteName: '洞結節付近',
    chamber: '右房・上外側',
    location: '上大静脈と右房の接合部の外側にある洞結節付近。模式図では表面の位置を投影しています。',
  ...
  },
  {
    ...
    siteName: '右心耳',
    chamber: '右房・前上方',
    location: '右房の前方に幅広く続く、三角形状の右心耳。先端は大動脈基部の近くへ向かいます。図では右房と連続する手前側の突起として示します。',
  ...
  },
  {
    ...
    siteName: '左心耳',
    chamber: '左房・前外側',
    location: '左房の前外側から張り出し、左上肺静脈より前方にある左心耳。肺動脈幹の左側に位置します。図は先端が前上方へ曲がる代表形で、形や先端の向きには個人差があります。',
  ...
  },
  {
    ...
    siteName: '冠静脈洞入口部',
    chamber: '右房・下後方',
    location: '右房の下後方・中隔寄りで、下大静脈の開口と三尖弁輪の間にある冠静脈洞の入口部です。',
