...
export const PAC_ORIGINS: PACOrigin[] = [
  {
    ...
    siteName: '分界稜付近',
    chamber: '右房・上方',
    location: '右房外側を上下に走る分界稜の上〜中部を、代表起源として置いています。',
    mainClue: 'Ⅱ・Ⅲ・aVFが陽性。V1は陽性／陰性の二相性が代表的。',
    why: '上方から下方へ広がる興奮が下壁誘導へ向かうため、下壁誘導のP′波は上向きになります。',
    limit: '上位分界稜では洞性P波によく似ることがあり、右上肺静脈との重なりもあります。',
    color: '#146ed6',
    polarities: {
      I: 'positive',
      II: 'positive',
  ...
  },
  {
    ...
    mainClue: 'Ⅱ・Ⅲ・aVFが深い陰性。aVLは陽性、V1は陰性から陽性が代表的。',
    why: '下方から上方へ広がる興奮が下壁誘導から離れるため、下壁誘導のP′波は下向きになります。',
    limit: '低位分界稜や下部三尖弁輪など、近接する右房下部起源でも似た形になります。',
    color: '#d67700',
    polarities: {
      I: 'positive',
      II: 'negative',
  ...
  },
  {
    ...
    mainClue: 'V1が幅広い陽性。I・aVLは陰性、下壁誘導は陽性が代表的。',
...
export function polarityPath(polarity: PWavePolarity, centerX: number, baseline: number, scale = 1): string {
