...
export const WPW_TYPES: WPWType[] = [
  {
    ...
    typeName: 'タイプA',
    attachment: '僧帽弁輪',
    anatomy: '代表位置は、左心房と左心室の間にある僧帽弁輪側。',
    v1Pattern: 'R ＞ S',
    v1Clue: 'V1でR波が優位なR／Rs型は、左側副伝導路を強く示唆する。',
    direction: '代表モデルでは、左室側から始まる早期興奮がV1へ向かう成分をつくり、R波が大きく見える。',
    clinicalLimit: '僧帽弁輪の前後など、左側の細かな位置はV1だけでは決められない。',
  ...
  },
  {
    ...
    typeName: 'タイプC',
    attachment: '中隔',
    anatomy: '代表位置は、右心系と左心系の境にある中隔付近。',
    v1Pattern: 'QS型',
    v1Clue: 'V1で最初から陰性のQS型は、中隔または右側副伝導路でみられる。',
    direction: '代表モデルでは、中隔の早期興奮によりV1で見えるはずの最初の小さなr波が消える。',
    clinicalLimit: 'QS型＝中隔と確定はできない。右側副伝導路でもQS型になることがある。',
  ...
  },
  {
    ...
    typeName: 'タイプB',
    attachment: '三尖弁輪',
    anatomy: '代表位置は、右心房と右心室の間にある三尖弁輪側。',
    v1Pattern: 'rS型',
    v1Clue: 'V1の小さなr波に深いS波が続くrS型は、右側または中隔副伝導路でみられる。',
    direction: '代表モデルでは、右室側から始まる早期興奮の主成分がV1から離れるため、S波が大きく見える。',
    clinicalLimit: 'rS型＝三尖弁輪と確定はできない。中隔副伝導路でもrS型になることがある。',
